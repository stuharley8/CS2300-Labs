...
command="horovodrun -np 8 -H localhost:8 python /home/harleys/CS-2300/lab8/model.py --data /data/cs2300/L8/ --h5modeloutput MGPUmAIprime_bs32_e5.h5 --model commaAiModelPrime --batch_size 32 --epochs 5"
