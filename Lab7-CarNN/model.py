...
def main():
    ...
    history_object = model.fit_generator(train_generator, steps_per_epoch= \
        len(train_samples)/my_batch_size/hvd.size(), validation_data=validation_generator, \
        validation_steps=len(validation_samples)/my_batch_size/hvd.size(), epochs=my_epochs, verbose=2, callbacks=callbacks)
