...
command="python /home/harleys/CS-2300/lab8/model.py --data /data/cs2300/L8/ --h5modeloutput mAIprime_bs128_e3.h5 --model commaAiModelPrime --batch_size 128 --epochs 3"
